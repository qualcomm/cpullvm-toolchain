...
2. [Fork](https://github.com/qualcomm/<REPLACE-ME>/fork) and clone the repository.
...
9. [Submit a pull request](https://github.com/qualcomm/<REPLACE-ME>/pulls) from your branch to `main`.
